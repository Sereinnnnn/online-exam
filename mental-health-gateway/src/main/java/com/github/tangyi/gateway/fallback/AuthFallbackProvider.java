...
public class AuthFallbackProvider implements FallbackProvider {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AuthFallbackProvider.class);

    private static final String AUTH_SERVICE_DISABLE = "授权服务不可用";
        ...
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() {
                if (cause != null && cause.getMessage() != null) {
                    ...
                    logger.error("调用:{} 异常：{}", getRoute(), AUTH_SERVICE_DISABLE);
