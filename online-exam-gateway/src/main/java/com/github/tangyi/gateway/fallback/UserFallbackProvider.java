...
public class UserFallbackProvider implements FallbackProvider {
    ...
    private static final String USER_SERVICE_DISABLE = "用户服务不可用";
        ...
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() {
                if (cause != null && cause.getMessage() != null) {
                    ...
                    logger.error("调用:{} 异常：{}", getRoute(), USER_SERVICE_DISABLE);
                    return new ByteArrayInputStream(USER_SERVICE_DISABLE.getBytes());
                }
            }
